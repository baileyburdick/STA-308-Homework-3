...
##    This is because the mean and medians are both similar (mean of 84.06 and median of 83.33 for 3 
##    and mean of 84.08 and median of 83.33 for 12).
##    Additionally, the minimum and 1st quartile for 12 tests is higher (minimum of 60.42 and 1st quartile of 81.25).
